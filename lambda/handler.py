...
def fire_analysis(event, context):
    ...
    period = event['queryStringParameters'].get('period', False)
...
def fire_alerts(event, context):
    ...
    try:
        params = util.validate_params(params)
    except ValueError, e:
        return serializers.api_error(str(e))
...
if __name__ == '__main__':
    ...
    event = {
        ...
        'fire_type': fire_type, 'period': '2016-01-01,2017-01-01', 'tile_id': '00N_110E'}
    }
